...
func create() {
	...
	sqlStmt := `
		...
		CREATE TABLE IF NOT EXISTS evolution_chain (id INTEGER PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS evolution_trigger (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS generation (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokedex (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS version (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS version_group (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS item (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS item_attribute (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS item_category (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS item_fling_effect (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS item_pocket (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS location (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS location_area (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pal_park_area (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS region (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS machine (id INTEGER PRIMARY KEY, data TEXT[] NOT NULL);
		...
		CREATE TABLE IF NOT EXISTS language (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
`
