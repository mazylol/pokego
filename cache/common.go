...
func create() {
	...
	sqlStmt := `
		...
		CREATE TABLE IF NOT EXISTS pokemon_location_area_list (count INTEGER PRIMARY KEY, data TEXT[] NOT NULL);
		...
		CREATE TABLE IF NOT EXISTS language_list (count INTEGER PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS berry (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS berry_firmness (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS berry_flavor (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS contest_type (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS contest_effect (id INTEGER PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS super_contest_effect (id INTEGER PRIMARY KEY, data TEXT[] NOT NULL);

		CREATE TABLE IF NOT EXISTS encounter_method (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS encounter_condition (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS encounter_condition_value (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		...
		CREATE TABLE IF NOT EXISTS characteristic (id INTEGER PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS egg_group (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS gender (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS growth_rate (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS nature (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokeathlon_stat (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_location_area (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_color (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_form (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_habitat (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_shape (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS pokemon_species (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS stat (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
		CREATE TABLE IF NOT EXISTS type (name VARCHAR(50) PRIMARY KEY, data TEXT[] NOT NULL);
